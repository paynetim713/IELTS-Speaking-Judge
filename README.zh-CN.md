...
<p align="center">
  ...
  <strong>链接:https://voice-ielts.onrender.com/</strong>
</p>
...
我做这个项目的原因很简单：很多口语练习工具看起来很智能，但练起来都很不舒服,很繁琐,有些工具只是随机问几个问题，有些只给一个分数，还有些不会模拟 Part 2 的准备时间和作答压力。真正考试的时候，考生要有节奏一路说下去，所以我希望这个项目更接近真实模考，而不是普通聊天机器人。这个项目主要适合想自己练口语、想反复复盘、想知道自己答案哪里可以改的雅思入门或者想进阶的人,现在模型只能给到最高8分,后续会更新更多。
